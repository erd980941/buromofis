...
<head>
  ...
  {{-- <title>{{config('global_settings.title')}}</title> --}}
  <title>{{$global_settings->title}} - Admin </title>
  {{-- <meta content="" name="description">
  <meta content="" name="keywords"> --}}

  <!-- Favicons -->
  <link href="{{ asset('assets/backend/img/favicon.png') }}" rel="stylesheet">
  <link href="{{ asset('assets/backend/img/apple-touch-icon.png') }}" rel="stylesheet">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">{{$global_settings->title}}</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" action="{{route('admin.login')}}" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">E-Posta</label>
                        ...
                        <div class="invalid-feedback">E-Posta Zorunludur.</div>
                    </div>
